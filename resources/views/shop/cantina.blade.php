      ...
      <div class="col-md-12">
        <div class="card" style="width:100%">
          <div style="background-color: #ffffff;overflow:auto" class="container ">
            ...
            <div class="container" style="position: absolute;background-color:white;padding:10;width:50%;display: inline-block">
              <?php       $senha=1; ?>
              <h4 class="title" style="vertical-align: middle;margin: 108 px 0;padding: 20px;text-overflow:hidden;background-color:#b8daff"><b>Nome:</b> Filipe Casimiro Stoianov Ivanov <br> <br>  <b>Num. Processo:</b> 12346178  <br> <br>

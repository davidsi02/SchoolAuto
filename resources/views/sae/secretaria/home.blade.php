								...
								<div class="row grid-divider">
									...
									<div class="col-sm-12 col-md-6 col-lg-3 my-1">
										<div class="card">
											...
											<img class="align-self-center" style="width: 100%;height:auto;transition: transform .4s;" dysplalign="left" src="{{$col->path_fotografia}}" alt="..."/>
											<h4 class="row col-md-12" style="height:100%;background-color: white;font-size:1vw;text-overflow:hidden">{{$col->name}}  <br>{{$col->time}} <br>@if($col->valor==1) <i class="fa fa-circle text-success"></i> @elseif($col->valor==2)  <i class="fa fa-circle text-danger" style="margin: 0 auto"></i>  @endif
											</h4>
										</div>
									</div>

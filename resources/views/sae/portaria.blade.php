...
<head>
  ...
  <title>SCHOOLGEST | Portaria</title>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-12 offset-md-30">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="GET" action= "{{ url('/portaria/registar') }}">

                                                <div class="col-md-12">
                                                    <input style="text-align:center;" id="input" type="text" name="input" autofocus>
...
@if (isset($_GET['ERROR']) && $_GET['ERROR'] == 1)
  ...
  <script>
alert("Numero de cartão não encontrado!");
  </script>
